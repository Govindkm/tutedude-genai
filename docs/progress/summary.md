...
> **Copilot: Read this file at every session start. It is the fast-read entry point.**
> For detailed session history → `docs/progress/sessions/`
> For topic-wise performance → `docs/progress/topics/`
> For exact last position → `docs/progress/checkpoint.md`
